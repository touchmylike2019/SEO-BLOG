...
// { blogs, categories, tags, size } คือ props ที่ Blogs.getInitialPropsส่งมา
...
// ส่ง props ให้กับ component Blog คือ { blogs: data.blogs, categories: data.categories, tags: data.tags, size: data.size }  
